    ...
    <main className="dashboard-shell">
      ...
      <footer className="dashboard-footer">
        ...
        <div className="footer-links">
          <a href="https://github.com/nyxscout/nyxscout-app" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://x.com/crystellenica" target="_blank" rel="noopener noreferrer">
